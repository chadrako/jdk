...
void InterpreterMacroAssembler::narrow(Register result) {
  ...
  ldr(rscratch1, Address(rfp, RegisterOrConstant(frame::interpreter_frame_method_offset * wordSize)));
  ldr(rscratch1, Address(rscratch1, RegisterOrConstant(Method::const_offset())));
  ldrb(rscratch1, Address(rscratch1, RegisterOrConstant(ConstMethod::result_type_offset())));
...
void InterpreterMacroAssembler::load_resolved_reference_at_index(
  ...
  ldr(result, Address(result, RegisterOrConstant(ConstantPool::cache_offset())));
  ldr(result, Address(result, RegisterOrConstant(ConstantPoolCache::resolved_references_offset())));
...
void InterpreterMacroAssembler::load_resolved_klass_at_offset(
  ...
  ldr(klass, Address(cpool,  RegisterOrConstant(ConstantPool::resolved_klasses_offset()))); // klass = cpool->_resolved_klasses
  add(klass, klass, temp, LSL, LogBytesPerWord);
  ldr(klass, Address(klass, RegisterOrConstant(Array<Klass*>::base_offset_in_bytes())));
}
