...
void TemplateInterpreterGenerator::generate_fixed_frame(bool native_call) {
  ...
  __ ldr(rcpool, Address(rmethod, Method::const_offset(), true));
  __ ldr(rcpool, Address(rcpool, ConstMethod::constants_offset(), true));
  __ ldr(rcpool, Address(rcpool, ConstantPool::cache_offset(), true));
...
void TemplateInterpreterGenerator::generate_throw_exception() {
...

  {
    ...
    // deoptimized caller
    __ get_method(r0);
    __ ldr(r0, Address(r0, Method::const_offset(), true));
